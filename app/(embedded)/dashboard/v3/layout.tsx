...
const NAV_ITEMS = [
  { label: 'Cart Activity',    href: '/dashboard/v3/overview' },
  { label: 'Cart Sessions',    href: '/dashboard/v3/sessions' },
  { label: 'Performance',      href: '/dashboard/v3/performance' },
  { label: 'Discounts',        href: '/dashboard/v3/discounts' },
  { label: 'Notifications',    href: '/dashboard/v3/notifications' },
];
